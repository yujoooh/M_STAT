...
ORG_FILE = '../INPUT/sporg.xlsx'
MOD_FILE = '../INPUT/spmod.xlsx'
#산출된 예보지수자료 읽기-------------------------------------------------------------------------
...
while ii < NUM_STN:
	...
	num = '%02d'% ii
	print(num)
	OUTFILE = '../OUTPUT/GRAPH/'+POINT_NAME+'_SP.dat' # 지점별 예측지수, 서비스지수 그래프 입력자료 저장파일
	print(OUTFILE)
	file = open(OUTFILE,'a')
	jj = 1
	kk = 1
